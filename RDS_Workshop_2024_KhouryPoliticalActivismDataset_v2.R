...
X$syria_post <- as.factor(ifelse(X$syria_post2011==1, "Yes", "No"))
...
# syria_post_reg <- glm(I(syria_post=="Yes") ~ sex_R + age, 
#						data=X_rds, 
#						family="binomial"(link="logit"))
# summary(syria_post_reg)

# syria_post_reg_weighted <- glm(I(syria_post=="Yes") ~ sex_R + age, 
#							data=X_rds, 
#							family="binomial"(link="logit"), 
#							weights=hcg_weights_syria_post)
